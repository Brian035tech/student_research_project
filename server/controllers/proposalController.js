...
db.query(
    ...
    (err, studentResults) => {
        ...
        // Check that the topic belongs
        // to the student, is approved,
        // and has a supervisor
                        ...
                        db.query(
                            ...
                            (err) => {
                                ...
                                .json({
                                    ...
                                    message:
                                        "Revised proposal submitted successfully and is awaiting supervisor review."
